...
| --- | --- | --- | --- |
| 900000107 | [Retrieve MedMij Core - ASA score](https://simplifier.net/guide/medmij-r4-core-ig/Home/Granular-Data-Service-Index/MedMij-Core-ASAScore?version=1.2.0) | Verzamelen MedMij Core - ASA-score | 1.0.0-rc.2 |
| 900000111 | [Retrieve MedMij Core - Encounter (zib2020/R4)](https://simplifier.net/guide/medmij-r4-core-ig/Home/Granular-Data-Service-Index/MedMij-Core-Encounter?version=1.2.0) | Verzamelen MedMij Core - Contact (zib2020/R4) | 1.0.0-rc.2 |
| 900000101 | [Retrieve MedMij Core - Patient (zib2020/R4)](https://simplifier.net/guide/medmij-r4-core-ig/Home/Granular-Data-Service-Index/MedMij-Core-Patient?version=1.2.0) | Verzamelen MedMij Core - Patient (zib2020/R4) | 1.0.0-rc.2 |
| 900000110 | [Retrieve MedMij Core - Payer (zib2020/R4)](https://simplifier.net/guide/medmij-r4-core-ig/Home/Granular-Data-Service-Index/MedMij-Core-Payer?version=1.2.0) | Verzamelen MedMij Core - Betaler (zib2020/R4) | 1.0.0-rc.2 |
| 900000103 | [Retrieve MedMij Core - Treatment objective (zib2020/R4)](https://simplifier.net/guide/medmij-r4-core-ig/Home/Granular-Data-Service-Index/MedMij-Core-TreatmentObjective?version=1.2.0) | Verzamelen MedMij Core - Behandeldoel (zib2020/R4) | 1.0.0-rc.2 |
...
The technical specifications with respect to the request message executed by the PHR and the response message of the XIS are detailed in the [MedMij R4 Core IG](https://simplifier.net/guide/medmij-r4-core-ig/Home/Granular-exchange?version=1.2.0#GeneralTechnicalSpecifications).

Moreover, the [MedMij R4 Core IG](https://simplifier.net/guide/medmij-r4-core-ig/Home/Granular-exchange?version=1.2.0#CareType) contains specifications and requirements regarding the care type, which is exchanged via the `.meta.tag` element. In particular, two SHOULD statements are part of these requirements. Note, however, that within Dental Care these two requirements are stricter, as the care type SHALL always be conveyed in Dental Care data, which means that at least one `.meta.tag` indicating the care type SHALL be added to each FHIR resource, provided the care type is known in the source system.