...
| **System role(s)** | MZ-PSR-beta.3 (PHR) <br/> MZ-PSB-beta.3 (XIS) |
...
| | |
| --- | --- |
| **FHIR profile(s)** | [http://medmij.nl/fhir/StructureDefinition/mz-PeriodicPeriodontalScreeningScore](https://simplifier.net/resolve?canonical=http://medmij.nl/fhir/StructureDefinition/mz-PeriodicPeriodontalScreeningScore&scope=medmij.fhir.nl.r4.dentalcare@1.0.0-beta.4) |
