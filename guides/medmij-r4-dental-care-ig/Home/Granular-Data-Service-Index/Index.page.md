...
This index contains all active domain-specific granular data services within Dental Care. The following is specified for each data service:
...
- **Overview**
    ...
    - **Data service version** - the version assigned to the data service as a whole (not to be confused with the version of the corresponding functional model or the package version of the corresponding FHIR profiles). More guidance on this version can be found [here](https://simplifier.net/guide/medmij-r4-core-ig/Home/Granular-exchange?version=1.2.0#VersioningGranularDataServices).
    - **System role(s)** - the system roles corresponding to the different transactions within each data service. Each system is of the form 'MZ-[CIM abbreviation]\[Transaction indicator\](-[Suffix])-[Data service version (abbreviated)]', where:
        - 'MZ' refers to Dental Care (Dutch: Mondzorg);
        ...
        - the Suffix is an optional addition, and is described in more detail [here](https://simplifier.net/guide/medmij-r4-core-ig/Home/Granular-exchange?version=1.2.0#PublicationGranularDataServices);
...
- **Functional model**
    ...
    - **Functional version** - the version of the CIM. For a CIM that is a zib, this version is of the form '_x.y_([zib publication])', e.g. '3.2(2020)'. For CIMs that are defined by MedMij as a Logical Model, the version of the corresponding FHIR package is suitable as the functional version. More guidance on this version can be found [here](https://simplifier.net/guide/medmij-r4-core-ig/Home/Granular-exchange?version=1.2.0#VersioningGranularDataServices).
...
- **Technical specification**
    ...
    - **Must Support** - the elements that have to be supported in the manner described [here](https://simplifier.net/guide/medmij-r4-core-ig/Home/Granular-exchange?version=1.2.0#MustSupport).
