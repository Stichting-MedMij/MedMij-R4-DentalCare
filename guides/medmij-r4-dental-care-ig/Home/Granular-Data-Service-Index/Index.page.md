...
- **Overview**
    ...
    - **Data service version** - the version assigned to the data service as a whole (not to be confused with the version of the corresponding functional model or the package version of the corresponding FHIR profiles). More guidance on this version can be found [here](https://simplifier.net/guide/medmij-r4-core-ig/Home/Granular-exchange?version=1.1.0#VersioningGranularDataServices).
